        ...
        return (
            <div className="fixed bottom-4 right-4 z-50">
                <button
                    ...
                    className="flex items-center justify-center w-14 h-14 rounded-full bg-slate-800/90 hover:bg-slate-700/90 text-white shadow-lg transition-all duration-300 hover:shadow-xl border border-slate-700/50 backdrop-blur-sm"
    ...
    return (
        <div className="min-w-96 h-full flex flex-col bg-transparent overflow-hidden">
            ...
            <div className="h-full w-full flex flex-col bg-slate-800/90 backdrop-blur-sm rounded-lg shadow-xl overflow-hidden border border-slate-700/50">
                {/* Header */}
                <div className="flex items-center justify-between px-5 py-4 bg-slate-700/90 border-b border-slate-600/90 drag-handle">
