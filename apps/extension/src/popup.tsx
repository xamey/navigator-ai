...
export default function Popup() {
        ...
        return (
            <div className="fixed bottom-4 right-4 z-50">
                <button
                    ...
                    className="flex items-center justify-center w-14 h-14 rounded-full bg-slate-800 hover:bg-slate-700 text-white shadow-lg transition-all duration-300 hover:shadow-xl border border-slate-700"
    ...
    return (
        <div className="w-96 bg-slate-800 rounded-lg shadow-xl overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between px-5 py-4 bg-slate-700 border-b border-slate-600">
                ...
                <button
                    ...
                    className="p-2 rounded-md text-slate-300 hover:text-white hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-400"
                    title="Minimize"
                >
            ...
            <div className="p-5 space-y-5">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-md shadow-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:opacity-60 disabled:cursor-not-allowed"
                    />
                </div>
                ...
                <div>
                    {!state.isRunning ? (
                        <button
                            ...
                            className="w-full px-4 py-3 text-white bg-blue-600 hover:bg-blue-700 rounded-md shadow-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
                        >
                            Start Automation
                        </button>
                    ) : (
                        <button
                            ...
                            className="w-full px-4 py-3 text-white bg-red-600 hover:bg-red-700 rounded-md shadow-sm font-medium focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors"
                        >
                            Stop Automation
                        </button>
                    )}
